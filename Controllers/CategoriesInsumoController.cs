...
[ApiController]
[Route("api/categoriainsumo")]
[Authorize]
public class CategoriainsumoController : ControllerBase
{
    private readonly LabDbContext _db;

    public CategoriainsumoController(LabDbContext db)
    {
        _db = db;
    }

    // ==========================================================
    // GET: listar categorías de insumo
    // ==========================================================
    [HttpGet]
    public async Task<IActionResult> Get([FromQuery] PagedQuery q)
    {
        var set = _db.CategoryInsumos.AsQueryable();
    ...
    {
        var x = await _db.CategoryInsumos.FindAsync(id);
    ...
    // ==========================================================
    [HttpPost]
    public async Task<IActionResult> Create(CategoryInsumo x)
    {
        _db.CategoryInsumos.Add(x);
    ...
    // ==========================================================
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Update(int id, CategoryInsumo x)
    {
        if (id != (x as dynamic).Id)
            return BadRequest();
